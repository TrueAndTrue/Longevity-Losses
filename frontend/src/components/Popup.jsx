    ...
    >
      ...
      >
        ...
        >
          ...
          <Text fontSize={'2xl'} ml={'75px'} mr={'50px'} color={'white'}>
            Before you can continue, we need you to answer a few questions to
            help guide your experience.
          </Text>
          <FormLabel color={'white'} mt={'30px'}>
            {' '}
            What is your weight goal? (lbs)
          </FormLabel>
          <Input
            bg={'white'}
            width={'20%'}
            color={'black'}
            onChange={weightGoalSetter}
          />
          <FormLabel color={'white'} mt={'30px'}>
            {' '}
          ...
          <Input
            ...
            name="daily"
            value={daily}
            onChange={changeDailyDirectly}
          />
          <FormHelperText color={'white'}>
            {' '}
            If you don't have one, use the recommended daily above.{' '}
          </FormHelperText>
          <Button
            mt={'25px'}
            bgColor={'green.400'}
